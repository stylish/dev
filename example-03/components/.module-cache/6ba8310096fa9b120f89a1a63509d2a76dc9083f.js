var Editor = React.createClass({displayName: "Editor",
  ...
  persist: function(){
    ...
    fs.writeFileSync(this.props.persist, contents)
  ...
  render: function(){
    ...
    return (React.createElement("div", {className: "app editor-pane"}, 
      ...
      React.createElement(CodemirrorEditor, {ref: "editor", value: props.value, mode: props.mode, onChange: props.onChange})
    ))
  }
});
