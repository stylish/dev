...
var EditorPanel = React.createClass({displayName: "EditorPanel",
  ...
  generatePreview: function(){
    var markupContent   = this.refs.markup_editor.persist(),
        ...
        previewContent  =  "<html> <head> <link rel='stylesheet' href='style.css' /> </head> <body>" + markupContent + "<script type='text/javascript' src='safe-script.js'></script></body></html>"
    
    fs.writeFileSync("src/app/editor-panel/new-preview.html", previewContent)
