var Editor = React.createClass({displayName: "Editor",
  ...
  saveToDisk: function(){
    ...
    var fs = Native.fs,
        path = Native.path,
        join = path.join,
        storagePath = join(Native.gui.App.dataPath, "editor-cache", this.props.folder, this.props.saveTo)
  ...
  read: function(){
    ...
    var storagePath = Native.path.join(Native.gui.App.dataPath, "editor-cache", this.props.folder, this.props.saveTo)
